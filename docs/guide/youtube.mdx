...
## 简介
* 为 YouTube 解锁`字幕`-`自动翻译`全语言选项，选择任一`自动翻译`语言，即为`字幕`+`自动翻译`双语字幕
...
<ModuleInstall urlPrefix="https://github.com/DualSubs/YouTube/releases/latest/download/">
  <ModuleInstall.Tab type="loon">
    <ModuleInstall.Item
      url="DualSubs.YouTube.plugin"
      badge={[
        {
          type: "tip",
          text: "MitM",
  ...
  <ModuleInstall.Tab type="stash">
    <ModuleInstall.Item
      url="DualSubs.YouTube.stoverride"
      badge={[
        {
          type: "info",
          text: "覆写",
  ...
  <ModuleInstall.Tab type="egern">
    <ModuleInstall.Item
      url="DualSubs.YouTube.yaml"
    />
  </ModuleInstall.Tab>
  <ModuleInstall.Tab type="qx">
    <ModuleInstall.Item
      url="DualSubs.YouTube.snippet"
      badge={[
        {
          type: "danger",
          text: "重写",
