...
<ModuleInstall
  urlPrefix="https://github.com/DualSubs/Universal/releases/latest/download/"
  urls={{
    loon: "DualSubs.Universal.plugin",
    surge: "DualSubs.Universal.sgmodule",
    stash: "DualSubs.Universal.stoverride",
    egern: "DualSubs.Universal.yaml",
    qx: "DualSubs.Universal.snippet",
    shadowrocket: "DualSubs.Universal.srmodule"
  }}
/>
