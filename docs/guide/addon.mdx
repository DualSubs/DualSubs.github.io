...
<ModuleInstall urlPrefix="https://github.com/DualSubs/AddOn/raw/main/modules/">
  <ModuleInstall.Tab type="loon">
    <ModuleInstall.Item url="DualSubs.AddOn.Microsoft.Translate.plugin"/>
  </ModuleInstall.Tab>
  <ModuleInstall.Tab type="surge">
    <ModuleInstall.Item url="DualSubs.AddOn.Microsoft.Translate.sgmodule"/>
  </ModuleInstall.Tab>
  <ModuleInstall.Tab type="stash">
    <ModuleInstall.Item url="DualSubs.AddOn.Microsoft.Translate.stoverride"/>
  </ModuleInstall.Tab>
  <ModuleInstall.Tab type="egern">
    <ModuleInstall.Item url="DualSubs.AddOn.Microsoft.Translate.yaml"/>
  </ModuleInstall.Tab>
  <ModuleInstall.Tab type="qx">
    <ModuleInstall.Item url="DualSubs.AddOn.Microsoft.Translate.snippet">
      - 修改配置文件，在`[task_local]`段添加如下内容:
      - ```*/10 * * * * https://github.com/DualSubs/AddOn/raw/main/js/AddOn.Microsoft.Translate.js, tag=🍿️ DualSubs: ➕ AddOn (Microsoft Translate), img-url=https://github.com/Koolson/Qure/raw/master/IconSet/Color/Microsoft.png, enabled=true```
    </ModuleInstall.Item>
  </ModuleInstall.Tab>
  <ModuleInstall.Tab type="shadowrocket">
    <ModuleInstall.Item url="DualSubs.AddOn.Microsoft.Translate.srmodule"/>
  </ModuleInstall.Tab>
</ModuleInstall>
