...
|  TV  |   [✅](https://apps.apple.com/hk/app/apple-tv/id1174078549)[^10]   |   [✅](https://apps.apple.com/hk/app/apple-tv/id1174078549?platform=appleTV)[^2][^9]   |   ✅[^2][^5]   |   N/A   |   ❓   |   N/A   |   Apple TV app中的购买与租借内容[^8]   |
| Fitness| [☑️](https://apps.apple.com/cn/app/fitness/id1208224953)[^9] |   ✅[^9]   |   N/A   |   N/A   |   ❓   |   N/A   | [^8] |
...
|         |         |         |         |         |         |        |        |
  ...
  [^9]: 首次播放时会先请求`play.itunes.apple.com`获取 HLS 密钥，此时`play.itunes.apple.com`不可`MitM`，需等到正常播放后，再将`play.itunes.apple.com`加入`MitM`列表。
  [^10]: 需要配合[ iRingo: 📺 TV](https://NSRingo.github.com/guide/apple-tv)恢复支持。
